...
namespace Fluorite.Vox.Editor
{
    static class Palette
    {
        ...
        #region Properties
        internal static Color32[] Colors { get; } = new Color32[maxColors];
        #endregion
        ...
        static Palette()
        {
            for (int i = 0; i < maxColors - 1; ++i) Colors[i] = new Color32((byte)(palettePrototype[i + 1] >> 0), (byte)(palettePrototype[i + 1] >> 8), (byte)(palettePrototype[i + 1] >> 16), (byte)(palettePrototype[i + 1] >> 24));
            Colors[maxColors - 1] = Color.black;
        }
        #endregion
    }
}